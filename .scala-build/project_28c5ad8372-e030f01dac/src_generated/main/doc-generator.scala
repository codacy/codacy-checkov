...
object `doc-generator` {
def args = `doc-generator_sc`.args$
/*<script>*///> using scala "2"
//> using lib "com.codacy::codacy-engine-scala-seed:5.0.3"
...
object `doc-generator_sc` {
  ...
  def main(args: Array[String]): Unit = {
    args$set(args)
    `doc-generator`.hashCode() // hasCode to clear scalac warning about pure expression in statement position
  }
}
